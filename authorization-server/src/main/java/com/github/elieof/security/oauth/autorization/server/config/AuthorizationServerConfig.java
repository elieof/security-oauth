...
public class AuthorizationServerConfig {
    ...
    @Bean
    public RegisteredClientRepository registeredClientRepository(UaaProperties uaaProperties) {
        RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId(uaaProperties.getWebClientConfiguration().getClientId())
                .clientSecret(uaaProperties.getWebClientConfiguration().getSecret())
